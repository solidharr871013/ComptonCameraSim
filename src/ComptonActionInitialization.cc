...
//
//
/// \file ComptonActionInitialization.cc
/// \brief Implementation of the ComptonActionInitialization class
...
{
  ComptonRunAction* runAction = new ComptonRunAction;
...
void ComptonActionInitialization::Build() const
{
  ...
  ComptonEventAction* eventAction = new ComptonEventAction(runAction);
  SetUserAction(eventAction);
  
  SetUserAction(new ComptonSteppingAction(eventAction));
}  
